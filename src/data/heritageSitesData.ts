...
// Additional Drone Shows and Light Shows images
import sitabuldiDroneShowImg from "@/assets/sites/sitabuldi-drone-show.jpg";
import ramtekLightShowImg from "@/assets/sites/ramtek-light-show.jpg";
import ambazariDroneShowImg from "@/assets/sites/ambazari-drone-show.jpg";
import dragonPalaceLightShowImg from "@/assets/sites/dragon-palace-light-show.jpg";
import nagardhanLightShowImg from "@/assets/sites/nagardhan-light-show.jpg";
import ajantaDroneShowImg from "@/assets/sites/ajanta-drone-show.jpg";
import sinhagadDroneShowImg from "@/assets/sites/sinhagad-drone-show.jpg";
import daulatabadLightShowImg from "@/assets/sites/daulatabad-light-show.jpg";
import ajantaLightShowImg from "@/assets/sites/ajanta-light-show.jpg";
import elloraLightShowImg from "@/assets/sites/ellora-light-show.jpg";
import vidhanaSoudhaDroneShowImg from "@/assets/sites/vidhana-soudha-drone-show.jpg";
import chitradurgaDroneShowImg from "@/assets/sites/chitradurga-drone-show.jpg";
import bidarLightShowImg from "@/assets/sites/bidar-light-show.jpg";
import belurLightShowImg from "@/assets/sites/belur-light-show.jpg";
import thanjavurDroneShowImg from "@/assets/sites/thanjavur-drone-show.jpg";
import maduraiDroneShowImg from "@/assets/sites/madurai-drone-show.jpg";
import gingeeLightShowImg from "@/assets/sites/gingee-light-show.jpg";
import velloreLightShowImg from "@/assets/sites/vellore-light-show.jpg";
import rameswaramDroneShowImg from "@/assets/sites/rameswaram-drone-show.jpg";
import kutchDroneShowImg from "@/assets/sites/kutch-drone-show.jpg";
import raniKiVavLightShowImg from "@/assets/sites/rani-ki-vav-light-show.jpg";
import somnathLightShowImg from "@/assets/sites/somnath-light-show.jpg";
import dwarkaDroneShowImg from "@/assets/sites/dwarka-drone-show.jpg";
...
export const heritageSitesData: HeritageSite[] = [
  ...
  { 
    ...
    openTime: "4:30 AM", 
    closeTime: "12:30 PM, 4:00 PM - 10:00 PM", 
    darshanTimings: "4:30 AM - 12:30 PM, 4:00 PM - 10:00 PM",
    entryFee: { indian: 0, foreign: 0 }, 
    vipPassAvailable: true, 
    vipPassPrice: 100, 
  ...
  // NAGPUR - Musical Fountain Show (Real attraction)
  { 
    id: "futala-musical-fountain", 
    ...
    tagline: "Central India's largest musical fountain with synchronized light and water show", 
    openTime: "7:00 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:00 PM, 7:30 PM, and 8:00 PM (Fri-Sun)", 
    entryFee: { indian: 20, foreign: 50, children: 10 }, 
    vipPassAvailable: false, 
    importance: "Nagpur's iconic musical fountain at Futala Lake features synchronized water jets, colorful LED lights, and music creating a spectacular evening entertainment.", 
    history: "Developed as part of Nagpur Smart City initiative, the musical fountain has become the city's most popular evening destination. The lake itself dates back to the Bhonsle era.", 
    architecture: "Modern lakeside promenade with amphitheater-style viewing areas", 
    averageExpenses: { budget: "₹100-200", mid: "₹300-500", premium: "₹800+" }, 
    tips: ["Weekend shows are longer and more elaborate", "Food stalls around the lake", "Best viewed from the main promenade", "Arrive 15 mins early for good spots"], 
    rating: 4.4, 
    bestTimeToVisit: "October to March (pleasant evenings)", 
    nearbyAttractions: ["Ambazari Lake", "Seminary Hills", "Deekshabhoomi"], 
    facilities: ["Parking", "Food Stalls", "Restrooms", "Boating available"],
    googleMapsUrl: "https://maps.google.com/?q=Futala+Lake+Nagpur",
    food: ["Street food stalls", "Lakeside cafes", "Tarri Poha", "Saoji snacks"],
    shopping: ["Local handicrafts", "Orange products", "Nagpur souvenirs"],
  ...
  { 
    id: "gateway-light-show", 
    name: "Gateway of India Light & Sound Show", 
    location: "Colaba, Mumbai", 
    region: "maharashtra", 
    type: "fort", 
    category: "light-show",
    image: gatewayDroneShowImg, 
    tagline: "Laser projection show on Mumbai's iconic Gateway monument with Arabian Sea backdrop", 
    openTime: "7:00 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:30 PM and 8:30 PM daily", 
    entryFee: { indian: 100, foreign: 300, children: 50 }, 
    vipPassAvailable: true, 
    vipPassPrice: 500, 
    importance: "The Gateway of India light and sound show projects India's independence journey and Mumbai's maritime heritage onto the iconic 1924 monument using laser technology.", 
    history: "Inaugurated in 2023 as part of Azadi Ka Amrit Mahotsav celebrations. The Gateway was built in 1924 to commemorate King George V's visit and witnessed the last British troops leaving India in 1948.", 
    architecture: "Indo-Saracenic triumphal arch facing the Arabian Sea", 
    averageExpenses: { budget: "₹400-700", mid: "₹1200-2000", premium: "₹3000+" }, 
    tips: ["Weekends are crowded", "Combine with Taj Palace visit", "Sunset views before show are beautiful", "Book ferry to Elephanta for next day"], 
    rating: 4.5, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Taj Mahal Palace", "Elephanta Caves", "Marine Drive", "Colaba Causeway"], 
    facilities: ["Open viewing", "Nearby restaurants", "Photography spots", "Ferry terminal"],
    googleMapsUrl: "https://maps.google.com/?q=Gateway+of+India+Mumbai",
    food: ["Taj restaurants", "Leopold Cafe", "Street food at Colaba Causeway", "Bade Miyan kebabs"],
    shopping: ["Colaba Causeway", "Taj boutiques", "Handicrafts", "Fashion Street"],
  ...
  // KARNATAKA - Drone Show (VERIFIED REAL - Guinness World Record 2025)
  { 
    ...
    tagline: "Guinness World Record drone show with 3000+ drones during Mysore Dasara", 
    openTime: "7:00 PM", 
    closeTime: "10:00 PM", 
    darshanTimings: "October 1-2 during Dasara festival (exact dates vary yearly)", 
    entryFee: { indian: 250, foreign: 600, children: 100 }, 
    vipPassAvailable: true, 
    vipPassPrice: 800, 
    importance: "India's largest drone show, part of the 400-year-old Mysore Dasara festival. In 2025, 3000+ drones created formations including Chamundeshwari, tigers, and mythological themes, setting a Guinness World Record.", 
    history: "The drone show was added to the traditional Dasara celebrations in 2022 and has grown annually. The 2025 show featured 3000 drones, making it one of the world's largest drone displays.", 
    architecture: "Indo-Saracenic Mysore Palace with 100,000 bulb illumination as backdrop", 
    averageExpenses: { budget: "₹600-1000", mid: "₹1500-2500", premium: "₹4000+" }, 
    tips: ["Only during Dasara festival (Sept-Oct)", "Book accommodation months in advance", "Combine with palace illumination", "Vijayadashami day has grand Jamboo Savari procession"], 
    rating: 4.9, 
    bestTimeToVisit: "September-October (10-day Dasara festival)", 
  ...
  // GUJARAT - Light & Laser Shows
  { 
    id: "statue-unity-show", 
    name: "Statue of Unity Light & Laser Show", 
    location: "Kevadia, Gujarat", 
    region: "gujarat", 
    type: "temple", 
    category: "drone-show",
    image: statueUnityDroneShowImg, 
    tagline: "Spectacular light and laser show at the world's tallest statue with special air shows on Ekta Diwas", 
    openTime: "7:00 PM", 
    closeTime: "9:30 PM", 
    darshanTimings: "Light shows daily at 7:30 PM; Air shows on Oct 31 (Ekta Diwas)", 
    entryFee: { indian: 150, foreign: 350, children: 75 }, 
    vipPassAvailable: true, 
    vipPassPrice: 500, 
    importance: "The Statue of Unity complex hosts nightly light and laser shows. On Rashtriya Ekta Diwas (Oct 31), the Indian Air Force performs spectacular flyovers with the Surya Kiran aerobatic team.", 
    history: "The 182-meter statue of Sardar Vallabhbhai Patel was inaugurated in 2018. The complex has evolved into Gujarat's premier tourist destination with multiple attractions and evening entertainment.", 
    architecture: "Modern viewing amphitheater with the world's tallest statue as backdrop", 
    averageExpenses: { budget: "₹800-1200", mid: "₹2000-3000", premium: "₹5000+" }, 
    tips: ["Book Tent City for overnight stay", "Oct 31 has special IAF aerial display", "Visit Valley of Flowers and Jungle Safari same day", "Book statue viewing gallery in advance"], 
    rating: 4.8, 
    bestTimeToVisit: "October to March, Oct 31 for Ekta Diwas special", 
    nearbyAttractions: ["Valley of Flowers", "Sardar Sarovar Dam", "Cactus Garden", "Jungle Safari"], 
    ...
    accommodation: ["Tent City Narmada", "Shrestha Bharat", "Jungle Safari Lodge", "SOU hotels"],
    placesNearby: [
      { name: "Valley of Flowers", distance: "1 km", type: "Garden" },
      { name: "Sardar Sarovar Dam", distance: "3 km", type: "Dam" },
      { name: "Cactus Garden", distance: "2 km", type: "Garden" },
  ...
  // ==================== ADDITIONAL DRONE SHOWS ====================

  // NAGPUR - Additional Drone Shows
  { 
    id: "sitabuldi-drone-show", 
    name: "Sitabuldi Fort Drone Spectacle", 
    location: "Sitabuldi Hill, Nagpur", 
    region: "nagpur", 
    type: "fort", 
    category: "drone-show",
    image: sitabuldiDroneShowImg, 
    tagline: "300+ drones recreating the historic 1817 Battle of Sitabuldi", 
    openTime: "7:00 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:30 PM on weekends", 
    entryFee: { indian: 150, foreign: 400, children: 75 }, 
    vipPassAvailable: true, 
    vipPassPrice: 350, 
    importance: "Unique drone show recreating the historic 1817 Battle of Sitabuldi between Maratha forces and the British East India Company atop the historic fort.", 
    history: "The show commemorates the pivotal battle that shaped Central India's colonial history. 300+ drones recreate battle formations and Maratha warrior imagery.", 
    architecture: "Historic British-era fort atop Sitabuldi Hill", 
    averageExpenses: { budget: "₹250-400", mid: "₹600-900", premium: "₹1500+" }, 
    tips: ["Weekend shows only", "Book online", "Fort opens for shows only", "Combine with Tekdi Ganesh visit"], 
    rating: 4.3, 
    bestTimeToVisit: "October to February", 
    nearbyAttractions: ["Tekdi Ganesh Temple", "Zero Mile Stone", "Central Museum"], 
    facilities: ["Seating", "Parking", "Restrooms", "Photography allowed"],
    googleMapsUrl: "https://maps.google.com/?q=Sitabuldi+Fort+Nagpur",
    food: ["Sitabuldi market food", "Haldiram's", "Local restaurants"],
    shopping: ["Sitabuldi Main Road", "Sadar", "Orange products"],
    accommodation: ["Hotel Centre Point", "Radisson Blu", "Pride Hotel"],
    placesNearby: [
      { name: "Tekdi Ganesh Temple", distance: "0.5 km", type: "Temple" },
      { name: "Zero Mile Stone", distance: "1 km", type: "Monument" },
      { name: "Central Museum", distance: "1.5 km", type: "Museum" },
      { name: "Futala Lake", distance: "4 km", type: "Lake" }
    ]
  },

  { 
    id: "ambazari-drone-show", 
    name: "Ambazari Lake Drone Festival", 
    location: "Ambazari, Nagpur", 
    region: "nagpur", 
    type: "temple", 
    category: "drone-show",
    image: ambazariDroneShowImg, 
    tagline: "400+ drones creating Vidarbha heritage patterns over the city's largest lake", 
    openTime: "6:30 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:00 PM and 8:00 PM", 
    entryFee: { indian: 100, foreign: 300, children: 50 }, 
    vipPassAvailable: true, 
    vipPassPrice: 300, 
    importance: "Nagpur's family-friendly drone show featuring 400+ drones creating tiger formations (Vidarbha's symbol), orange patterns, and cultural motifs over Ambazari Lake.", 
    history: "Started in 2024 as part of Nagpur Smart City's entertainment initiative. The lake's calm waters create beautiful drone reflections.", 
    architecture: "Lakeside amphitheater with modern amenities", 
    averageExpenses: { budget: "₹200-350", mid: "₹500-800", premium: "₹1200+" }, 
    tips: ["Best lake reflections at 7 PM show", "Boating available before show", "Food court on premises", "Family-friendly venue"], 
    rating: 4.4, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Ambazari Garden", "Seminary Hills", "Japanese Rose Garden"], 
    facilities: ["Amphitheater seating", "Food court", "Boating", "Parking"],
    googleMapsUrl: "https://maps.google.com/?q=Ambazari+Lake+Nagpur",
    food: ["Lakeside cafes", "Street food", "Garden View restaurant"],
    shopping: ["Dharampeth shops", "Law College Square market"],
    accommodation: ["Hotel Tuli Imperial", "Pride Hotel", "Le Meridien"],
    placesNearby: [
      { name: "Seminary Hills", distance: "1 km", type: "Hill" },
      { name: "Japanese Rose Garden", distance: "3 km", type: "Garden" },
      { name: "Raman Science Centre", distance: "2 km", type: "Museum" },
      { name: "Deekshabhoomi", distance: "3 km", type: "Monument" }
    ]
  },

  { 
    id: "futala-drone-festival", 
    name: "Futala Lake Mega Drone Show", 
    location: "Futala, Nagpur", 
    region: "nagpur", 
    type: "temple", 
    category: "drone-show",
    image: nagpurDroneShowImg, 
    tagline: "Central India's largest 600-drone show with musical fountain synchronization", 
    openTime: "7:00 PM", 
    closeTime: "9:30 PM", 
    darshanTimings: "Main show 7:30 PM - 8:15 PM", 
    entryFee: { indian: 200, foreign: 500, children: 100 }, 
    vipPassAvailable: true, 
    vipPassPrice: 500, 
    importance: "Flagship drone show of Central India featuring 600+ drones synchronized with the famous Futala musical fountain, creating a multi-sensory experience.", 
    history: "Upgraded in 2025 with India's first fountain-drone synchronization technology. Celebrates Nagpur's culture, history, and its status as India's geographic center.", 
    architecture: "Modern lakefront venue with dedicated viewing zones", 
    averageExpenses: { budget: "₹350-550", mid: "₹800-1200", premium: "₹2000+" }, 
    tips: ["Musical fountain starts 30 min before drones", "Premium zone has best fountain view", "Weekend shows are longer", "Pre-book for festivals"], 
    rating: 4.7, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Seminary Hills", "Ambazari Lake", "Dragon Palace"], 
    facilities: ["VIP lounge", "Food court", "Premium parking", "Live streaming"],
    googleMapsUrl: "https://maps.google.com/?q=Futala+Lake+Nagpur",
    food: ["Futala food street", "Garden restaurants", "Multi-cuisine options"],
    shopping: ["Futala market", "Nearby malls", "Handicrafts"],
    accommodation: ["Le Meridien", "Radisson Blu", "Tuli Imperial"],
    placesNearby: [
      { name: "Seminary Hills", distance: "1.5 km", type: "Hill" },
      { name: "Ambazari Lake", distance: "2 km", type: "Lake" },
      { name: "Dragon Palace Temple", distance: "12 km", type: "Temple" },
      { name: "Law College Square", distance: "3 km", type: "Area" }
    ]
  },

  // NAGPUR - Additional Light Shows
  { 
    id: "ramtek-light-show", 
    name: "Ramtek Fort Temple Light Show", 
    location: "Ramtek, Nagpur", 
    region: "nagpur", 
    type: "temple", 
    category: "light-show",
    image: ramtekLightShowImg, 
    tagline: "Ramayana stories come alive through hilltop temple projections", 
    openTime: "7:00 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:30 PM (Hindi/Marathi)", 
    entryFee: { indian: 30, foreign: 200, children: 15 }, 
    vipPassAvailable: false, 
    importance: "The show narrates Lord Rama's exile journey and his connection to Ramtek, where he is believed to have rested during his 14-year vanvas (exile).", 
    history: "Started in 2020, the show uses the ancient hilltop temple complex as its canvas, bringing alive stories from the Ramayana and local legends.", 
    architecture: "Ancient temple complex with Vakatakas and Bhonsle-era structures", 
    averageExpenses: { budget: "₹300-500", mid: "₹800-1200", premium: "₹2000+" }, 
    tips: ["Combine with temple darshan", "Stay for night aarti", "Drive carefully on hill road", "Monsoon shows suspended"], 
    rating: 4.4, 
    bestTimeToVisit: "October to March, Ram Navami special", 
    nearbyAttractions: ["Khindsi Lake", "Nagardhan Fort", "Pench Tiger Reserve"], 
    facilities: ["Temple seating", "Audio system", "Parking", "Prasad"],
    googleMapsUrl: "https://maps.google.com/?q=Ramtek+Temple+Nagpur",
    food: ["Temple prasad", "Local vegetarian food", "Ramtek market"],
    shopping: ["Religious items", "Orange products", "Local handicrafts"],
    accommodation: ["MTDC Resort", "Temple dharamshala", "Nagpur hotels"],
    placesNearby: [
      { name: "Khindsi Lake", distance: "8 km", type: "Lake" },
      { name: "Nagardhan Fort", distance: "6 km", type: "Fort" },
      { name: "Pench Tiger Reserve", distance: "45 km", type: "Wildlife" },
  ...
  { 
    id: "dragon-palace-light-show", 
    name: "Dragon Palace Buddhist Light Show", 
    location: "Kamptee Road, Nagpur", 
    region: "nagpur", 
    type: "temple", 
    category: "light-show",
    image: dragonPalaceLightShowImg, 
    tagline: "Serene Buddhist teachings through Japanese-style temple illuminations", 
    openTime: "6:30 PM", 
    closeTime: "8:30 PM", 
    darshanTimings: "Shows at 7:00 PM daily", 
    entryFee: { indian: 50, foreign: 150, children: 25 }, 
    vipPassAvailable: false, 
    importance: "Unique light show narrating Buddha's life and teachings through the spectacular Japanese-architecture Dragon Palace Temple, promoting peace and mindfulness.", 
    history: "The Dragon Palace, built by Japanese Buddhists, hosts this meditative light experience since 2018. Features chanting, light projections, and peaceful ambience.", 
    architecture: "Japanese Buddhist architecture with pagoda and meditation halls", 
    averageExpenses: { budget: "₹200-400", mid: "₹600-900", premium: "₹1500+" }, 
    tips: ["Meditation session after show", "Remove shoes", "Photography restricted inside", "Peaceful atmosphere maintained"], 
    rating: 4.5, 
    bestTimeToVisit: "Year-round, Buddha Purnima special", 
    nearbyAttractions: ["Deekshabhoomi", "Ramtek Temple", "Nagpur city"], 
    facilities: ["Meditation hall", "Garden", "Parking", "Gift shop"],
    googleMapsUrl: "https://maps.google.com/?q=Dragon+Palace+Temple+Nagpur",
    food: ["Vegetarian cafeteria", "Japanese-style meals"],
    shopping: ["Buddhist items", "Meditation accessories", "Books"],
    accommodation: ["Nearby hotels", "Guest house on premises"],
    placesNearby: [
      { name: "Deekshabhoomi", distance: "15 km", type: "Monument" },
      { name: "Kamptee", distance: "5 km", type: "Town" },
      { name: "Koradi Temple", distance: "10 km", type: "Temple" },
      { name: "Nagpur city", distance: "18 km", type: "City" }
    ]
  },

  { 
    id: "nagardhan-light-show", 
    name: "Nagardhan Vakataka Heritage Show", 
    location: "Nagardhan, Nagpur", 
    region: "nagpur", 
    type: "fort", 
    category: "light-show",
    image: nagardhanLightShowImg, 
    tagline: "Ancient Vakataka dynasty capital illuminated with archaeological discoveries", 
    openTime: "6:30 PM", 
    closeTime: "8:30 PM", 
    darshanTimings: "Shows at 7:00 PM (weekends only)", 
    entryFee: { indian: 25, foreign: 200, children: 10 }, 
    vipPassAvailable: false, 
    importance: "The show brings alive the 4th-5th century Vakataka dynasty that ruled from Nagardhan, showcasing recent archaeological discoveries and Prabhavati Gupta's legacy.", 
    history: "ASI launched this show in 2021 to highlight excavations revealing royal seals, coins, and the connection between Vakatakas and Guptas through Queen Prabhavati Gupta.", 
    architecture: "Vakataka-era fort ruins and archaeological site", 
    averageExpenses: { budget: "₹250-400", mid: "₹600-900", premium: "₹1500+" }, 
    tips: ["Weekend shows only", "Visit archaeological museum first", "Combine with Ramtek", "Guide recommended for context"], 
    rating: 4.2, 
    bestTimeToVisit: "October to February", 
    nearbyAttractions: ["Ramtek Temple", "Khindsi Lake", "Mansar Lake"], 
    facilities: ["Open-air seating", "Museum", "Parking", "Guides"],
    googleMapsUrl: "https://maps.google.com/?q=Nagardhan+Fort+Nagpur",
    food: ["Local eateries", "Ramtek restaurants nearby"],
    shopping: ["Archaeological replicas", "Local crafts"],
    accommodation: ["Ramtek hotels", "Nagpur city hotels"],
    placesNearby: [
      { name: "Ramtek Temple", distance: "6 km", type: "Temple" },
      { name: "Khindsi Lake", distance: "12 km", type: "Lake" },
      { name: "Mansar Lake", distance: "15 km", type: "Archaeological" },
      { name: "Nagpur", distance: "35 km", type: "City" }
    ]
  },

  // MAHARASHTRA - Additional Drone Shows
  { 
    id: "ajanta-drone-show", 
    name: "Ajanta Caves Drone Experience", 
    location: "Ajanta, Aurangabad", 
    region: "maharashtra", 
    type: "temple", 
    category: "drone-show",
    image: ajantaDroneShowImg, 
    tagline: "500+ drones recreating Buddhist Jataka tales over UNESCO heritage site", 
    openTime: "6:30 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:00 PM and 8:00 PM", 
    entryFee: { indian: 200, foreign: 600, children: 100 }, 
    vipPassAvailable: true, 
    vipPassPrice: 500, 
    importance: "Spectacular drone show at UNESCO World Heritage Ajanta Caves recreating Buddhist Jataka tales and ancient paintings through 500+ synchronized LED drones.", 
    history: "Launched in 2023, the show celebrates the 2000-year-old Buddhist cave paintings and sculptures using modern drone technology to tell ancient stories.", 
    architecture: "2nd century BCE rock-cut caves as backdrop", 
    averageExpenses: { budget: "₹600-900", mid: "₹1500-2500", premium: "₹4000+" }, 
    tips: ["Combine with cave visit during day", "Book accommodation in Aurangabad", "Photography allowed", "Moonless nights are best"], 
    rating: 4.6, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Ellora Caves", "Bibi Ka Maqbara", "Daulatabad Fort"], 
    facilities: ["Seating", "Audio guides", "Parking", "MTDC accommodation"],
    googleMapsUrl: "https://maps.google.com/?q=Ajanta+Caves+Maharashtra",
    food: ["MTDC restaurant", "Aurangabad cuisine", "Local dhabas"],
    shopping: ["Cave art replicas", "Handicrafts", "Buddhist items"],
    accommodation: ["MTDC Ajanta", "Aurangabad hotels", "Fardapur homestays"],
    placesNearby: [
      { name: "Ellora Caves", distance: "100 km", type: "Caves" },
      { name: "Aurangabad", distance: "107 km", type: "City" },
      { name: "Jalgaon", distance: "60 km", type: "City" },
      { name: "Fardapur", distance: "4 km", type: "Village" }
    ]
  },

  { 
    id: "sinhagad-drone-show", 
    name: "Sinhagad Fort Maratha Drone Show", 
    location: "Sinhagad, Pune", 
    region: "maharashtra", 
    type: "fort", 
    category: "drone-show",
    image: sinhagadDroneShowImg, 
    tagline: "400+ drones recreating Tanaji Malusare's legendary conquest", 
    openTime: "6:30 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:00 PM (weekends and holidays)", 
    entryFee: { indian: 150, foreign: 400, children: 75 }, 
    vipPassAvailable: true, 
    vipPassPrice: 400, 
    importance: "Patriotic drone show recreating the legendary 1670 Battle of Sinhagad where Tanaji Malusare scaled the fort walls to recapture it for Chhatrapati Shivaji Maharaj.", 
    history: "Started in 2022, the show uses 400+ drones to recreate the night battle, rope scaling, and Tanaji's sacrifice that inspired the saying 'Gad aala pan sinha gela'.", 
    architecture: "17th century Maratha hilltop fortress", 
    averageExpenses: { budget: "₹500-800", mid: "₹1200-2000", premium: "₹3000+" }, 
    tips: ["Trek up or use vehicles", "Weekend shows only", "Cold at night - carry jacket", "Arrive before sunset for views"], 
    rating: 4.5, 
    bestTimeToVisit: "October to February", 
    nearbyAttractions: ["Khadakwasla Dam", "Panshet Dam", "Lavasa"], 
    facilities: ["Open-air seating", "Snack stalls", "Basic parking"],
    googleMapsUrl: "https://maps.google.com/?q=Sinhagad+Fort+Pune",
    food: ["Zunka bhakri", "Pitla", "Kanda bhaji at fort", "Sinhagad special pithla"],
    shopping: ["Fort souvenirs", "Local honey", "Handicrafts"],
    accommodation: ["Pune city hotels", "Camping on fort (permission required)"],
    placesNearby: [
      { name: "Khadakwasla Dam", distance: "15 km", type: "Dam" },
      { name: "Pune City", distance: "35 km", type: "City" },
      { name: "Panshet Dam", distance: "25 km", type: "Dam" },
      { name: "Torna Fort", distance: "20 km", type: "Fort" }
    ]
  },

  // MAHARASHTRA - Additional Light Shows
  { 
    id: "daulatabad-light-show", 
    name: "Daulatabad Fort Sound & Light Show", 
    location: "Daulatabad, Aurangabad", 
    region: "maharashtra", 
    type: "fort", 
    category: "light-show",
    image: daulatabadLightShowImg, 
    tagline: "Experience the impregnable Devagiri fortress through dramatic projections", 
    openTime: "7:00 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:15 PM and 8:15 PM", 
    entryFee: { indian: 25, foreign: 300, children: 10 }, 
    vipPassAvailable: false, 
    importance: "The show narrates the history of the 'unconquerable' Devagiri fort, from Yadava kings to Muhammad bin Tughlaq's mad plan to shift Delhi's capital here.", 
    history: "The 12th century fort saw rule by Yadavas, Delhi Sultanate, Bahmanis, and Mughals. The show dramatically recreates the ingenious defense mechanisms and dark passages.", 
    architecture: "12th century Yadava fortress carved into volcanic rock", 
    averageExpenses: { budget: "₹300-500", mid: "₹800-1200", premium: "₹2000+" }, 
    tips: ["Visit fort during day first", "Bring flashlight for dark passages", "Combine with Ellora visit", "Dramatic at full moon"], 
    rating: 4.5, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Ellora Caves", "Bibi Ka Maqbara", "Aurangabad caves"], 
    facilities: ["Seating", "Audio in multiple languages", "Parking"],
    googleMapsUrl: "https://maps.google.com/?q=Daulatabad+Fort+Aurangabad",
    food: ["Aurangabad biryani", "Naan qalia", "Local Dhabas"],
    shopping: ["Himroo shawls", "Bidriware", "Paithani sarees"],
    accommodation: ["Aurangabad hotels", "MTDC resort"],
    placesNearby: [
      { name: "Ellora Caves", distance: "15 km", type: "Caves" },
      { name: "Aurangabad", distance: "15 km", type: "City" },
      { name: "Bibi Ka Maqbara", distance: "13 km", type: "Monument" },
      { name: "Khuldabad", distance: "8 km", type: "Town" }
    ]
  },

  { 
    id: "ajanta-light-show", 
    name: "Ajanta Caves Sound & Light Show", 
    location: "Ajanta Viewpoint", 
    region: "maharashtra", 
    type: "temple", 
    category: "light-show",
    image: ajantaLightShowImg, 
    tagline: "Ancient Buddhist cave paintings illuminated with artistic projections", 
    openTime: "6:30 PM", 
    closeTime: "8:30 PM", 
    darshanTimings: "Shows at 6:45 PM and 7:45 PM", 
    entryFee: { indian: 50, foreign: 400, children: 25 }, 
    vipPassAvailable: false, 
    importance: "The show illuminates the UNESCO World Heritage caves with projections explaining the Jataka tales, Buddhist philosophy, and the incredible artistry of ancient painters.", 
    history: "Started in 2019, the show uses the horseshoe-shaped gorge as a natural amphitheater, projecting stories onto the cliff face above the caves.", 
    architecture: "2nd century BCE to 6th century CE rock-cut Buddhist caves", 
    averageExpenses: { budget: "₹400-600", mid: "₹1000-1500", premium: "₹2500+" }, 
    tips: ["Caves close at sunset - show starts after", "View from interpretation center", "Combine with day cave visit", "Best in clear weather"], 
    rating: 4.6, 
    bestTimeToVisit: "October to March (caves closed Mondays)", 
    nearbyAttractions: ["Ellora Caves", "Aurangabad", "Pitalkhora Caves"], 
    facilities: ["Auditorium seating", "Museum", "Parking", "Cafeteria"],
    googleMapsUrl: "https://maps.google.com/?q=Ajanta+Caves+Maharashtra",
    food: ["MTDC cafeteria", "Local restaurants", "Aurangabad food"],
    shopping: ["Cave painting replicas", "Buddhist artifacts", "Handicrafts"],
    accommodation: ["MTDC Ajanta Resort", "Fardapur homestays", "Aurangabad hotels"],
    placesNearby: [
      { name: "Ellora Caves", distance: "100 km", type: "Caves" },
      { name: "Pitalkhora Caves", distance: "40 km", type: "Caves" },
      { name: "Aurangabad", distance: "107 km", type: "City" },
      { name: "Jalgaon", distance: "60 km", type: "City" }
    ]
  },
  ...
  { 
    id: "ellora-light-show", 
    name: "Ellora Kailasa Temple Light Show", 
    location: "Ellora, Aurangabad", 
    region: "maharashtra", 
    type: "temple", 
    category: "light-show",
    image: elloraLightShowImg, 
    tagline: "The world's largest monolithic rock excavation illuminated in splendor", 
    openTime: "7:00 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:15 PM and 8:15 PM", 
    entryFee: { indian: 40, foreign: 400, children: 20 }, 
    vipPassAvailable: true, 
    vipPassPrice: 200, 
    importance: "Spectacular show illuminating the Kailasa Temple (Cave 16) - the world's largest monolithic rock excavation, carved top-down from a single basalt cliff.", 
    history: "The 8th century Rashtrakuta masterpiece took 18 years and removed 200,000 tons of rock. The show narrates this incredible engineering feat and Hindu mythology.", 
    architecture: "8th century rock-cut Dravidian temple complex", 
    averageExpenses: { budget: "₹400-600", mid: "₹1000-1500", premium: "₹2500+" }, 
    tips: ["Visit caves during day", "Kailasa Temple best at twilight", "Combine with Daulatabad", "Full moon nights magical"], 
    rating: 4.7, 
    bestTimeToVisit: "October to March (caves closed Tuesdays)", 
    nearbyAttractions: ["Daulatabad Fort", "Bibi Ka Maqbara", "Grishneshwar Temple"], 
    facilities: ["Seating", "Audio guides", "Parking", "Museum"],
    googleMapsUrl: "https://maps.google.com/?q=Ellora+Caves+Maharashtra",
    food: ["MTDC cafeteria", "Khuldabad restaurants", "Aurangabad cuisine"],
    shopping: ["Stone carvings", "Handicrafts", "Religious items"],
    accommodation: ["MTDC Ellora", "Khuldabad stays", "Aurangabad hotels"],
    placesNearby: [
      { name: "Daulatabad Fort", distance: "15 km", type: "Fort" },
      { name: "Grishneshwar Temple", distance: "1 km", type: "Temple" },
      { name: "Khuldabad", distance: "5 km", type: "Town" },
      { name: "Aurangabad", distance: "30 km", type: "City" }
    ]
  },

  // KARNATAKA - Additional Drone Shows
  { 
    id: "vidhana-soudha-drone", 
    name: "Vidhana Soudha Republic Day Drone Show", 
    location: "Bangalore", 
    region: "karnataka", 
    type: "fort", 
    category: "drone-show",
    image: vidhanaSoudhaDroneShowImg, 
    tagline: "1000+ drones creating Karnataka heritage patterns over the iconic building", 
    openTime: "6:30 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Special shows on Republic Day and Independence Day", 
    entryFee: { indian: 0, foreign: 0, children: 0 }, 
    vipPassAvailable: false, 
    importance: "Spectacular free drone show over Karnataka's seat of legislature featuring 1000+ drones creating Indian flag, Karnataka emblem, and cultural formations.", 
    history: "Started in 2024, the show celebrates India's democracy with the magnificent Vidhana Soudha (built 1956) as backdrop. Special shows on national holidays.", 
    architecture: "Neo-Dravidian style granite legislature building", 
    averageExpenses: { budget: "₹200-400", mid: "₹600-1000", premium: "₹1500+" }, 
    tips: ["Free entry - arrive early", "Best views from Cubbon Park side", "Republic Day show is grandest", "Sunday illumination also beautiful"], 
    rating: 4.6, 
    bestTimeToVisit: "January 26, August 15, Sundays for illumination", 
    nearbyAttractions: ["Cubbon Park", "High Court", "Karnataka Museum"], 
    facilities: ["Open-air viewing", "Nearby food options", "Metro access"],
    googleMapsUrl: "https://maps.google.com/?q=Vidhana+Soudha+Bangalore",
    food: ["MG Road restaurants", "Cubbon Park cafes", "Food streets"],
    shopping: ["MG Road", "Brigade Road", "Commercial Street"],
    accommodation: ["Taj West End", "ITC Gardenia", "Oberoi"],
    placesNearby: [
      { name: "Cubbon Park", distance: "0.2 km", type: "Park" },
      { name: "Karnataka High Court", distance: "0.5 km", type: "Building" },
      { name: "Bangalore Palace", distance: "3 km", type: "Palace" },
      { name: "Lalbagh Gardens", distance: "4 km", type: "Garden" }
    ]
  },

  { 
    id: "chitradurga-drone-show", 
    name: "Chitradurga Fort Nayaka Drone Show", 
    location: "Chitradurga", 
    region: "karnataka", 
    type: "fort", 
    category: "drone-show",
    image: chitradurgaDroneShowImg, 
    tagline: "300+ drones recreating Onake Obavva's legendary bravery", 
    openTime: "6:30 PM", 
    closeTime: "8:30 PM", 
    darshanTimings: "Shows at 7:00 PM (weekends)", 
    entryFee: { indian: 100, foreign: 300, children: 50 }, 
    vipPassAvailable: false, 
    importance: "Inspiring drone show recreating the legend of Onake Obavva, who single-handedly defended the fort against Hyder Ali's army using a pestle (onake).", 
    history: "The Stone Fortress with 7 concentric walls has witnessed Nayaka, Mysore, and Maratha rule. The show celebrates local heroes and the fort's 'impregnable' status.", 
    architecture: "15th-18th century stone fortress with 7 walls and 38 entrances", 
    averageExpenses: { budget: "₹300-500", mid: "₹800-1200", premium: "₹2000+" }, 
    tips: ["Trek the fort during day", "Carry water", "Weekend shows only", "Local guides available"], 
    rating: 4.3, 
    bestTimeToVisit: "October to February", 
    nearbyAttractions: ["Chandravalli Caves", "Hidimba Hill", "Jogimatti Wildlife Sanctuary"], 
    facilities: ["Open seating", "Parking", "Restrooms", "Snacks"],
    googleMapsUrl: "https://maps.google.com/?q=Chitradurga+Fort+Karnataka",
    food: ["Jolada rotti", "Local Karnataka cuisine", "Dhabas"],
    shopping: ["Stone carvings", "Local crafts"],
    accommodation: ["Chitradurga hotels", "KSTDC guest house"],
    placesNearby: [
      { name: "Chandravalli Caves", distance: "5 km", type: "Caves" },
      { name: "Hidimba Hill", distance: "8 km", type: "Hill" },
      { name: "Jogimatti Wildlife", distance: "12 km", type: "Wildlife" },
      { name: "Davanagere", distance: "75 km", type: "City" }
    ]
  },

  // KARNATAKA - Additional Light Shows
  { 
    id: "bidar-light-show", 
    name: "Bidar Fort Bahmani Light Show", 
    location: "Bidar", 
    region: "karnataka", 
    type: "fort", 
    category: "light-show",
    image: bidarLightShowImg, 
    tagline: "Deccan Sultanate grandeur through medieval fortress illuminations", 
    openTime: "6:30 PM", 
    closeTime: "8:30 PM", 
    darshanTimings: "Shows at 7:00 PM", 
    entryFee: { indian: 20, foreign: 200, children: 10 }, 
    vipPassAvailable: false, 
    importance: "The show narrates the glory of the Bahmani Sultanate (1347-1527 CE) whose capital Bidar was a center of learning, art, and the famous Bidriware craft.", 
    history: "Bidar Fort with its triple moat and massive walls became Bahmani capital in 1429. The show highlights Persian-influenced architecture and cultural achievements.", 
    architecture: "15th century Bahmani fort with Persian influences", 
    averageExpenses: { budget: "₹300-500", mid: "₹800-1200", premium: "₹2000+" }, 
    tips: ["Visit Bidar Museum first", "Buy Bidriware", "Combine with Bidar monuments tour", "Less crowded than other shows"], 
    rating: 4.3, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Mahmud Gawan Madrasa", "Barid Shahi tombs", "Bidar Museum"], 
    facilities: ["Seating", "Audio guides", "Parking"],
    googleMapsUrl: "https://maps.google.com/?q=Bidar+Fort+Karnataka",
    food: ["Bidar cuisine", "Local restaurants", "Dhabas"],
    shopping: ["Bidriware", "Handicrafts", "Local products"],
    accommodation: ["Hotel Mayura", "Private hotels", "Guest houses"],
    placesNearby: [
      { name: "Mahmud Gawan Madrasa", distance: "1 km", type: "Monument" },
      { name: "Barid Shahi Tombs", distance: "2 km", type: "Tombs" },
      { name: "Bidar Museum", distance: "1 km", type: "Museum" },
      { name: "Gurudwara Nanak Jhira", distance: "3 km", type: "Gurudwara" }
    ]
  },

  { 
    id: "belur-light-show", 
    name: "Belur Chennakeshava Temple Light Show", 
    location: "Belur, Hassan", 
    region: "karnataka", 
    type: "temple", 
    category: "light-show",
    image: belurLightShowImg, 
    tagline: "Hoysala sculptural masterpiece illuminated in golden splendor", 
    openTime: "6:30 PM", 
    closeTime: "8:30 PM", 
    darshanTimings: "Shows at 7:00 PM", 
    entryFee: { indian: 25, foreign: 300, children: 10 }, 
    vipPassAvailable: false, 
    importance: "The show illuminates the 12th century Chennakeshava Temple, highlighting the 48 intricately carved pillars, each unique, and the legendary dancer Darpana Sundari sculpture.", 
    history: "Built by Vishnuvardhana in 1117 CE to commemorate his victory over Cholas. The temple took 103 years to complete. The show reveals details invisible in daylight.", 
    architecture: "Hoysala soapstone temple with intricate carvings", 
    averageExpenses: { budget: "₹400-600", mid: "₹1000-1500", premium: "₹2500+" }, 
    tips: ["Visit during day for detailed viewing", "Combine with Halebidu", "Local guides excellent", "Photography restrictions during show"], 
    rating: 4.5, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Halebidu Temple", "Shravanabelagola", "Chikmagalur"], 
    facilities: ["Temple seating", "Audio guides", "Parking"],
    googleMapsUrl: "https://maps.google.com/?q=Chennakeshava+Temple+Belur",
    food: ["Hassan cuisine", "Temple prasad", "Local restaurants"],
    shopping: ["Soapstone carvings", "Handicrafts", "Silk"],
    accommodation: ["Hassan hotels", "Belur guest houses", "Homestays"],
    placesNearby: [
      { name: "Halebidu Temple", distance: "16 km", type: "Temple" },
      { name: "Shravanabelagola", distance: "80 km", type: "Pilgrimage" },
      { name: "Hassan", distance: "40 km", type: "City" },
      { name: "Chikmagalur", distance: "60 km", type: "Hill Station" }
    ]
  },

  // TAMIL NADU - Additional Drone Shows
  { 
    id: "thanjavur-drone-show", 
    name: "Brihadeeswarar Temple Drone Festival", 
    location: "Thanjavur", 
    region: "tamil-nadu", 
    type: "temple", 
    category: "drone-show",
    image: thanjavurDroneShowImg, 
    tagline: "600+ drones creating Chola dynasty patterns over UNESCO temple", 
    openTime: "6:30 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:00 PM and 8:00 PM", 
    entryFee: { indian: 150, foreign: 500, children: 75 }, 
    vipPassAvailable: true, 
    vipPassPrice: 400, 
    importance: "Spectacular drone show over the UNESCO World Heritage Brihadeeswarar Temple, celebrating 1000 years of Chola architecture, maritime power, and cultural achievements.", 
    history: "Started in 2020 for the temple's 1000th anniversary. 600+ drones recreate Rajaraja Chola's coronation, naval fleet, and the famous 80-ton capstone installation.", 
    architecture: "11th century Chola Dravidian temple with 66m vimana", 
    averageExpenses: { budget: "₹400-600", mid: "₹1000-1500", premium: "₹2500+" }, 
    tips: ["Pongal festival shows are grand", "Temple darshan closes at 8 PM", "Combine with palace visit", "Book VIP for temple views"], 
    rating: 4.7, 
    bestTimeToVisit: "October to March, Pongal special", 
    nearbyAttractions: ["Thanjavur Palace", "Saraswathi Mahal Library", "Gangaikonda Cholapuram"], 
    facilities: ["Premium seating", "Food stalls", "Parking", "Temple facilities"],
    googleMapsUrl: "https://maps.google.com/?q=Brihadeeswarar+Temple+Thanjavur",
    food: ["Thanjavur meals", "Filter coffee", "Banana chips"],
    shopping: ["Thanjavur paintings", "Bronze idols", "Silk sarees"],
    accommodation: ["Svatma", "Oriental Towers", "Ideal River View"],
    placesNearby: [
      { name: "Thanjavur Palace", distance: "0.5 km", type: "Palace" },
      { name: "Saraswathi Mahal Library", distance: "0.5 km", type: "Library" },
      { name: "Gangaikonda Cholapuram", distance: "70 km", type: "Temple" },
      { name: "Kumbakonam", distance: "40 km", type: "Town" }
    ]
  },

  { 
    id: "madurai-drone-show", 
    name: "Meenakshi Temple Drone Spectacle", 
    location: "Madurai", 
    region: "tamil-nadu", 
    type: "temple", 
    category: "drone-show",
    image: maduraiDroneShowImg, 
    tagline: "700+ drones creating temple gopuram formations over ancient Madurai", 
    openTime: "7:00 PM", 
    closeTime: "9:30 PM", 
    ...
    vipPassAvailable: true, 
    vipPassPrice: 400, 
    importance: "Mesmerizing drone show over the iconic Meenakshi Amman Temple featuring 700+ drones recreating the 14 gopurams, divine wedding themes, and Madurai's 2500-year history.", 
    history: "Launched in 2023 to boost Madurai tourism. The show narrates Pandya dynasty glory, the divine wedding of Meenakshi and Sundareswarar, and temple architecture.", 
    architecture: "Historic Madurai cityscape with temple as backdrop", 
    averageExpenses: { budget: "₹400-700", mid: "₹1200-2000", premium: "₹3000+" }, 
    tips: ["Combine with evening temple ceremony", "Rooftop restaurants have views", "Chithirai festival shows are special", "Traffic heavy - arrive early"], 
    rating: 4.6, 
    bestTimeToVisit: "October to March, Chithirai festival", 
    nearbyAttractions: ["Meenakshi Temple", "Thirumalai Nayakkar Palace", "Gandhi Museum"], 
    facilities: ["Seating", "Food stalls", "Parking", "Restrooms"],
    googleMapsUrl: "https://maps.google.com/?q=Meenakshi+Temple+Madurai",
    food: ["Jigarthanda", "Madurai meals", "Banana leaf feast"],
    shopping: ["Sungudi sarees", "Brass items", "Temple jewelry"],
    accommodation: ["Taj Madurai", "Heritage Madurai", "Fortune Pandiyan"],
    placesNearby: [
      { name: "Meenakshi Temple", distance: "0 km", type: "Temple" },
      { name: "Thirumalai Nayakkar Palace", distance: "1 km", type: "Palace" },
      { name: "Gandhi Museum", distance: "3 km", type: "Museum" },
      { name: "Thiruparankundram", distance: "8 km", type: "Temple" }
    ]
  },

  { 
    id: "rameswaram-drone-show", 
    name: "Rameswaram Temple Drone Festival", 
    location: "Rameswaram", 
    region: "tamil-nadu", 
    type: "temple", 
    category: "drone-show",
    image: rameswaramDroneShowImg, 
    tagline: "500+ drones creating Ramayana themes over the sacred island", 
    openTime: "6:30 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:00 PM and 8:00 PM", 
    entryFee: { indian: 100, foreign: 400, children: 50 }, 
    vipPassAvailable: true, 
    vipPassPrice: 300, 
    importance: "Sacred drone show recreating Ramayana stories over the Ramanathaswamy Temple and Bay of Bengal, celebrating Lord Rama's Lanka conquest.", 
    history: "Started in 2024 as part of Rameswaram development. 500+ drones recreate the Ram Setu legend, Hanuman's journey, and the temple's famous 1000-pillar corridor.", 
    architecture: "Seaside temple with world's longest temple corridor", 
    averageExpenses: { budget: "₹400-600", mid: "₹1000-1600", premium: "₹2500+" }, 
    tips: ["Best during Maha Shivaratri", "Sea breeze makes viewing pleasant", "Combine with 22 wells ritual", "Pamban Bridge sunset beforehand"], 
    rating: 4.5, 
    bestTimeToVisit: "October to April", 
    nearbyAttractions: ["Pamban Bridge", "Dhanushkodi", "APJ Abdul Kalam House"], 
    facilities: ["Beach seating", "Food stalls", "Parking"],
    googleMapsUrl: "https://maps.google.com/?q=Ramanathaswamy+Temple+Rameswaram",
    food: ["Temple prasad", "Seafood", "South Indian meals"],
    shopping: ["Rudraksha", "Conch shells", "Religious items"],
    accommodation: ["Hotel Tamil Nadu", "Daiwik Hotels", "Temple accommodation"],
    placesNearby: [
      { name: "Dhanushkodi", distance: "20 km", type: "Beach" },
      { name: "Pamban Bridge", distance: "2 km", type: "Bridge" },
      { name: "APJ Abdul Kalam House", distance: "15 km", type: "Museum" },
      { name: "Agni Theertham", distance: "0.5 km", type: "Beach" }
    ]
  },

  // TAMIL NADU - Additional Light Shows
  { 
    id: "gingee-light-show", 
    name: "Gingee Fort Sound & Light Show", 
    location: "Gingee, Villupuram", 
    region: "tamil-nadu", 
    type: "fort", 
    category: "light-show",
    image: gingeeLightShowImg, 
    tagline: "The 'Troy of the East' illuminated with Nayaka-Maratha glory", 
    openTime: "6:30 PM", 
    closeTime: "8:30 PM", 
    darshanTimings: "Shows at 7:00 PM", 
    entryFee: { indian: 25, foreign: 300, children: 10 }, 
    vipPassAvailable: false, 
    importance: "The show narrates the dramatic history of Gingee Fort - called 'Troy of the East' by the British - from Chola builders to Maratha conquest and Tipu Sultan's siege.", 
    history: "The 13th century fort on three hills changed hands between Vijayanagara, Nayakas, Marathas, Mughals, French, and British. The show dramatizes its impregnable reputation.", 
    architecture: "13th-17th century hilltop fortress complex", 
    averageExpenses: { budget: "₹300-500", mid: "₹800-1200", premium: "₹2000+" }, 
    tips: ["Trek Rajagiri Hill during day", "Bring water and snacks", "Show at Krishnagiri base", "Less crowded alternative to other forts"], 
    rating: 4.3, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Pondicherry", "Auroville", "Thiruvannamalai"], 
    facilities: ["Open seating", "Parking", "Basic amenities"],
    googleMapsUrl: "https://maps.google.com/?q=Gingee+Fort+Tamil+Nadu",
    food: ["Local Tamil food", "Villupuram restaurants"],
    shopping: ["Local crafts", "Villupuram market"],
    accommodation: ["Villupuram hotels", "Pondicherry hotels"],
    placesNearby: [
      { name: "Pondicherry", distance: "70 km", type: "City" },
      { name: "Thiruvannamalai", distance: "60 km", type: "Temple Town" },
      { name: "Auroville", distance: "75 km", type: "Township" },
      { name: "Villupuram", distance: "25 km", type: "Town" }
    ]
  },

  { 
    id: "vellore-light-show", 
    name: "Vellore Fort Sound & Light Show", 
    location: "Vellore", 
    region: "tamil-nadu", 
    type: "fort", 
    category: "light-show",
    image: velloreLightShowImg, 
    tagline: "Vijayanagara grandeur and Tipu Sultan's legacy through moat reflections", 
    openTime: "7:00 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:15 PM and 8:15 PM", 
    entryFee: { indian: 25, foreign: 300, children: 10 }, 
    vipPassAvailable: false, 
    importance: "The show narrates Vellore Fort's 500-year history from Vijayanagara builders through Bijapur, Maratha, and Tipu Sultan rule, including the 1806 Sepoy Mutiny.", 
    history: "Built in 16th century with massive granite walls and double moat (still water-filled). The show dramatically uses moat reflections for visual effect.", 
    architecture: "16th century granite fort with water-filled moat", 
    averageExpenses: { budget: "₹300-500", mid: "₹800-1200", premium: "₹2000+" }, 
    tips: ["Visit Jalakandeswarar Temple inside", "Moat reflections spectacular", "Government Museum worth visiting", "Chennai day trip possible"], 
    rating: 4.4, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Golden Temple Sripuram", "VIT University", "Yelagiri Hills"], 
    facilities: ["Seating", "Parking", "Museum", "Temple access"],
    googleMapsUrl: "https://maps.google.com/?q=Vellore+Fort+Tamil+Nadu",
    food: ["Vellore biryani", "Local restaurants", "CMC canteen"],
    shopping: ["Handlooms", "Local crafts"],
    accommodation: ["Hotel Darling Residency", "GRT Regency", "Budget hotels"],
    placesNearby: [
      { name: "Golden Temple Sripuram", distance: "8 km", type: "Temple" },
      { name: "Yelagiri Hills", distance: "80 km", type: "Hill Station" },
      { name: "Chennai", distance: "145 km", type: "City" },
      { name: "Tiruvannamalai", distance: "90 km", type: "Temple Town" }
    ]
  },

  // GUJARAT - Additional Drone Shows
  { 
    id: "kutch-drone-show", 
    name: "Rann Utsav Mega Drone Show", 
    location: "Rann of Kutch, Bhuj", 
    region: "gujarat", 
    type: "fort", 
    category: "drone-show",
    image: kutchDroneShowImg, 
    tagline: "1000+ drones creating patterns over the white salt desert under full moon", 
    openTime: "7:00 PM", 
    closeTime: "10:00 PM", 
    darshanTimings: "Shows at 7:30 PM and 9:00 PM during Rann Utsav", 
    entryFee: { indian: 400, foreign: 1000, children: 200 }, 
    vipPassAvailable: true, 
    vipPassPrice: 1200, 
    importance: "India's most unique drone show over the white Rann desert featuring 1000+ drones creating Kutchi embroidery patterns, flamingos, and cultural motifs.", 
    history: "Part of Gujarat Tourism's Rann Utsav festival (November-February). The white desert becomes a natural canvas as drones create art visible for kilometers.", 
    architecture: "Natural white salt desert with tent city facilities", 
    averageExpenses: { budget: "₹800-1200", mid: "₹2500-4000", premium: "₹8000+" }, 
    tips: ["Full moon nights are magical", "Book tent city in advance", "Combine with Kutch handicraft villages", "Carry warm clothes for night"], 
    rating: 4.9, 
    bestTimeToVisit: "November to February (Rann Utsav)", 
    nearbyAttractions: ["Bhuj", "Wild Ass Sanctuary", "Kutch Museum"], 
    facilities: ["Tent city", "Cultural performances", "Desert activities", "Full-service resort"],
    googleMapsUrl: "https://maps.google.com/?q=White+Rann+of+Kutch",
    food: ["Kutchi thali", "Desert camp cuisine", "Traditional dhokla-fafda"],
    shopping: ["Kutchi embroidery", "Rogan art", "Bandhani textiles", "Local handicrafts"],
    accommodation: ["Rann Utsav Tent City", "Kutch Resort", "Bhuj hotels"],
    placesNearby: [
      { name: "Bhuj", distance: "80 km", type: "City" },
      { name: "Wild Ass Sanctuary", distance: "50 km", type: "Wildlife" },
      { name: "Kala Dungar", distance: "95 km", type: "Viewpoint" },
      { name: "Hodka Village", distance: "60 km", type: "Craft Village" }
    ]
  },

  { 
    id: "dwarka-drone-show", 
    name: "Dwarkadhish Temple Drone Festival", 
    location: "Dwarka", 
    region: "gujarat", 
    type: "temple", 
    category: "drone-show",
    image: dwarkaDroneShowImg, 
    tagline: "500+ drones creating Krishna Leela themes over the sacred Char Dham", 
    openTime: "6:30 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:00 PM and 8:00 PM", 
    entryFee: { indian: 150, foreign: 400, children: 75 }, 
    vipPassAvailable: true, 
    vipPassPrice: 400, 
    importance: "Sacred drone show at one of the Char Dhams featuring 500+ drones recreating Krishna's life, Mahabharata scenes, and the legendary submerged city of Dwarka.", 
    history: "Started in 2023 to enhance pilgrimage experience. Drones recreate Krishna's coronation as Dwarkadhish, the 12 Jyotirlingas connection, and underwater city legends.", 
    architecture: "5-story temple with 72 pillars on Arabian Sea coast", 
    averageExpenses: { budget: "₹400-700", mid: "₹1200-2000", premium: "₹3000+" }, 
    tips: ["Janmashtami shows are grand", "Combine with Bet Dwarka visit", "Sea breeze adds to experience", "Book during pilgrimage season"], 
    rating: 4.6, 
    bestTimeToVisit: "October to March, Janmashtami", 
    nearbyAttractions: ["Bet Dwarka", "Nageshwar Jyotirlinga", "Sudama Setu"], 
    facilities: ["Seating", "Food stalls", "Parking", "Restrooms"],
    googleMapsUrl: "https://maps.google.com/?q=Dwarkadhish+Temple+Gujarat",
    food: ["Temple prasad", "Gujarati thali", "Fresh seafood"],
    shopping: ["Krishna idols", "Religious items", "Dwarka souvenirs"],
    accommodation: ["GTDC hotels", "Dwarkadhish Guest House", "Budget hotels"],
    placesNearby: [
      { name: "Bet Dwarka", distance: "30 km", type: "Island Temple" },
      { name: "Nageshwar Jyotirlinga", distance: "17 km", type: "Temple" },
      { name: "Sudama Setu", distance: "2 km", type: "Bridge" },
      { name: "Gomti Ghat", distance: "0.5 km", type: "Ghat" }
    ]
  },

  // GUJARAT - Additional Light Shows
  { 
    id: "rani-ki-vav-light-show", 
    name: "Rani ki Vav Sound & Light Show", 
    location: "Patan", 
    region: "gujarat", 
    type: "temple", 
    category: "light-show",
    image: raniKiVavLightShowImg, 
    tagline: "UNESCO stepwell masterpiece illuminated revealing 500+ sculptures", 
    openTime: "7:00 PM", 
    closeTime: "9:00 PM", 
    darshanTimings: "Shows at 7:15 PM and 8:15 PM", 
    entryFee: { indian: 40, foreign: 400, children: 20 }, 
    vipPassAvailable: false, 
    importance: "Spectacular light show illuminating the inverted temple - a 7-story stepwell with 500+ principal sculptures and 1000+ minor ones, built as a memorial to a king.", 
    history: "Queen Udayamati built this in 1063 CE as a memorial to her husband Bhimdev I. Buried by floods for centuries, rediscovered in 1940s. Featured on ₹100 note.", 
    architecture: "11th century Maru-Gurjara style inverted temple stepwell", 
    averageExpenses: { budget: "₹400-600", mid: "₹1000-1500", premium: "₹2500+" }, 
    tips: ["Visit during day to see sculptures", "Photography allowed", "Combine with Modhera Sun Temple", "Featured on ₹100 note"], 
    rating: 4.7, 
    bestTimeToVisit: "October to March", 
    nearbyAttractions: ["Modhera Sun Temple", "Patan Patola", "Siddhpur"], 
    facilities: ["Seating", "Audio guides", "Parking", "Museum"],
    googleMapsUrl: "https://maps.google.com/?q=Rani+ki+Vav+Patan",
    food: ["Patan snacks", "Gujarati thali", "Local restaurants"],
    shopping: ["Patola sarees", "Handicrafts", "Souvenirs"],
    accommodation: ["Patan hotels", "Mehsana hotels", "Heritage stays"],
    placesNearby: [
      { name: "Modhera Sun Temple", distance: "25 km", type: "Temple" },
      { name: "Patola House", distance: "2 km", type: "Weaving Center" },
      { name: "Siddhpur", distance: "30 km", type: "Town" },
      { name: "Ahmedabad", distance: "130 km", type: "City" }
    ]
  },

  { 
    id: "somnath-light-show", 
    name: "Somnath Temple Sound & Light Show", 
    location: "Somnath, Veraval", 
    region: "gujarat", 
    type: "temple", 
    category: "light-show",
    image: somnathLightShowImg, 
    tagline: "The Eternal Shrine's 1000-year saga of destruction and resurrection", 
    openTime: "7:30 PM", 
    closeTime: "9:30 PM", 
    darshanTimings: "Shows at 8:00 PM and 9:00 PM", 
    entryFee: { indian: 35, foreign: 300, children: 15 }, 
    vipPassAvailable: true, 
    vipPassPrice: 100, 
    importance: "Moving show narrating Somnath's saga - destroyed 17 times and rebuilt each time, symbolizing Indian civilization's resilience. First among 12 Jyotirlingas.", 
    history: "The temple was destroyed by Mahmud of Ghazni (1025 CE), Delhi Sultanate, and Mughals, rebuilt each time. The current temple was built after Independence in 1951.", 
    architecture: "Chalukya-style temple on Arabian Sea coast", 
    averageExpenses: { budget: "₹400-600", mid: "₹1000-1600", premium: "₹2500+" }, 
    tips: ["Sea aarti at 7 PM before show", "Arrow pillar points to South Pole", "Maha Shivaratri shows grand", "Combine with Prabhas Patan museum"], 
    rating: 4.8, 
    bestTimeToVisit: "October to March, Maha Shivaratri", 
    nearbyAttractions: ["Bhalka Tirtha", "Gir National Park", "Junagadh"], 
    facilities: ["Seating", "Multiple language audio", "Parking", "Temple facilities"],
    googleMapsUrl: "https://maps.google.com/?q=Somnath+Temple+Gujarat",
    food: ["Temple prasad", "Gujarati thali", "Seafood"],
    shopping: ["Shivling replicas", "Religious items", "Handicrafts"],
    accommodation: ["GTDC hotels", "Temple trust accommodation", "Veraval hotels"],
    placesNearby: [
      { name: "Bhalka Tirtha", distance: "5 km", type: "Temple" },
      { name: "Gir National Park", distance: "45 km", type: "Wildlife" },
      { name: "Junagadh", distance: "85 km", type: "City" },
      { name: "Diu", distance: "90 km", type: "Beach" }
    ]
  },
];
